...
"""
    ...
    def generate_outline(self, user_theme: str, style_preferences: str = "general fiction", num_outlines: int = 2) -> List[str]:
        ...
        try:
            # Increased max_tokens: e.g., 300 words/overview * num_outlines + prompt overhead
            # 300 words is roughly 400 tokens. For 2 outlines: 2*400 = 800. Add buffer for prompt and formatting.
            # Let's use 500 tokens per outline as a safer estimate.
            estimated_tokens_per_outline = 500
            total_max_tokens = (estimated_tokens_per_outline * num_outlines) + 200 # 200 for prompt and other text
