...
*   **[p] Narrative Pathfinder Agent (概述智能体 - README 4.3.1)**
    ...
    *   `[p]` Generates multiple core creative overviews (MVP: 2). Workflow selects the first. (Live LLM call fully enabled; prompt refined; README specifies 3-5 options, 500-1000 words, user selection TODO).
...
*   **[p] Plot Architect Agent (大纲智能体 - README 4.3.3)**
    ...
    *   `[p]` Prompt and parsing updated to generate chapter-by-chapter plot summaries. (Live LLM call fully enabled; prompt and parsing refined; README specifies 1-2 detailed chapter outlines, further quality/detail refinement TODO).
...
*   **[p] Phase 1.b: Live LLM Testing, Prompt Tuning, and Output Stabilization**
    ...
    *   `[p]` Iteratively Refine Agent Prompts & Parsing based on Real Outputs (Initial major pass DONE; ongoing as needed).
